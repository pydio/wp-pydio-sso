...
class WP_Pydio_SSO {
	...
	public function get_defaults() {
		...
		$defaults = array(
			'install_path'	=> 'http://vvv.dev/pydio/core/src/', // @todo clear this!!
	...
	public function section_creds() { ?>
		...
		<p>
			<?php _e( 'Set the data to connect to your Pydio installation', 'wp-pydio-sso' ); ?>
		</p>
	...
	public function section_options() { ?>
		...
		<p>
			<?php _e( 'Define how WordPress and Pydio should interact', 'wp-pydio-sso' ); ?>
		</p>
	...
	public function section_repo() {
		...
		<p>
			...
			<ul>
				<li><code>.<?php echo $installPath; ?>/wp-content/themes</code> : <?php _e( 'The wordpress themes contents', 'wp-pydio-sso' ); ?><li>
				<li><code>.<?php echo $installPath; ?>/wp-content/plugins</code> : <?php _e( 'The wordpress plugins', 'wp-pydio-sso' ); ?><li>
				<li><code>.<?php echo $installPath . '/' . get_option( 'upload_path' ); ?></code> : <?php _e( 'The media library', 'wp-pydio-sso' ); ?><li>
			</ul>
